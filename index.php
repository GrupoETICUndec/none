...
<html>
	...
	<script src="./assets/jscode.js"></script>
		...
		<div class="login-form-1">
			<form id="login-form" class="text-left">
				...
				<div class="main-login-form">
				    ...
				    <button type="submit" class="login-button" formmethod="post" formaction="./paginas/login.php"><i class="fa fa-chevron-right"></i></button>
				</div>

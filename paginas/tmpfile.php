...
<div class="container" style="padding-top: 60px;">
  ...
  <div class="row">
    ...
    <div class="col-md-8 col-sm-6 col-xs-12 personal-info">
      ...
      <h3>Personal info</h3>
      <form class="form-horizontal" role="form" id="formeditprofile">
        ...
        <div class="form-group">
          ...
          <div class="col-md-8">
            <input class="form-control" value="11111122333" type="password" id="password" title="Password must contain at least 8 characters and numbers" required pattern="(?=.*\d)(?=.*[a-z]).{8,40}" onchange="this.setCustomValidity(this.validity.patternMismatch ? this.title : ''); form.password_confirm.pattern = this.value;">
          </div>
        </div>
        <div class="form-group">
          <label class="col-md-3 control-label">Confirm password:</label>
          <div class="col-md-8">
            <input class="form-control" value="11111122333" type="password" id="password_confirm" title="Password must match" required pattern="(?=.*\d)(?=.*[a-z]).{8,40}">
          </div>
        </div>
        <div class="form-group">
